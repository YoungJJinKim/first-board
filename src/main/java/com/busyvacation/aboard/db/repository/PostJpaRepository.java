...
public interface PostJpaRepository extends JpaRepository<Post,String>{
	...
	public ArrayList<Post> findAllByOrderByPostidDesc();
	public ArrayList<Post> findAllByOrderByRecommendedDesc();
	public ArrayList<Post> findAllByOrderByViewcountDesc();
}
